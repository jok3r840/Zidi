#!/usr/bin/python
# coding=utf-8
# Originally Written By:Nawabzadi X Faisal
# Source : Python2"
# Donot Recode It. 
...
\x1b[1;92m➣ AQIB ALI:  https://www.facebook.com/chuza840
\x1b[1;92m➣ Facebook:  FAISU D'CRUZ
\x1b[1;92m➣ Whatsapp: 03030299818
\x1b[1;94m______________________________________________"""
# titik #
def tik():
	titik = [".   ","..  ","... "]
...
def methodlogin():
	...
	if hos =="":
		...
		time.sleep(1)
		os.system('xdg-open https://www.facebook.com/chuza840')
		os.system('python2 .hop2.py')
